...
- Ultimate Member Account Forms (login, lost password, and registration)
- WPForms
...
* [Enhancement] Added a module to protect the Ultimate Member account forms (Login, lost password, registration).
* [Bugfix] Fixed the broken verification of the WordPress comments.
* [Bugfix] Fixed the process issue when logging in with the Ultimate Member login form without the mosparo Integration enabled.
...
* [Bugfix] Contact Form 7: Fixed a bug with the event handling with forms without mosparo.
...
* [Bugfix] Contact Form 7: Fixed incorrect event handling, particularly in invisible mode.
...
* [Bugfix] Fixed multiple issues with the Gravity Forms module in combination with the AJAX submitting method and the invisible mosparo mode.
...
* [Bugfix] JetFormBuilder: Removed the range field type from the list of ignored types because mosparo validates the range fields, but the module ignored it.
